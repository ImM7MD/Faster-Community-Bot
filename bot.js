...
client.channels.find('id', '484015956788772864').setName(`Time - ${hours} : ${ReBeeL} : ${ReBeeeL} ${suffix}`) 
client.channels.find('id', '484015985075027968').setName(`Date : ${Codes} - ${CodeS} - ${CoDeS}`)
}, 1000);
});
