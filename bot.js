...
// لو ما كتب تبليغ بيقوله اكتب تبليغ
  if (!args) return msg.reply(`امممم .. اكتب تذكرتك`)
// استبدل <الروم> بأسم الروم حقك
  if (msg.guild.channels.find('name', 'تذكرة')) {
// استبدل هنا بعد
    msg.guild.channels.find('name', 'تذكرة').send(`
 **** : ${msg.mentions.members.first()}
  **تم انشاه التذكرة من قبل** : ${msg.author}
  **في روم** : ${msg.channel.name}
 **التذكرة** : **${args.join(" ").split(msg.mentions.members.first()).slice(' ')}**
  `)
  }
}
})
